...
class AppSettings(object):
    ...
    def MAX_RUN_TIME(self):
        """
        Maximum possible task run time, after which tasks will be unlocked and tried
        again.
        """
    ...
    def BACKGROUND_TASK_PRIORITY_ORDERING(self):
        ...
        A niceness of −20 is the highest priority and 19 is the lowest priority. The
        default niceness for processes is inherited from its parent process and is
        usually 0.
        """
